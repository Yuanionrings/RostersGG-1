export default TermsAndConditions = () => {
    return(
        <div>
            ...
            <p>These terms and conditions outline the rules and regulations for the use of Rosters.gg's 
                Website, located at https://www.rosters.gg.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue 
                to use Rosters.gg if you do not agree to take all of the terms and conditions stated on this page. Our Terms and Conditions were created with the help of the <a href="https://www.termsandconditionsgenerator.com">Terms And Conditions Generator</a> and the <a href="https://www.privacypolicyonline.com/terms-conditions-generator/">Free Terms & Conditions Generator</a>.</p>
            ...
            <p>We employ the use of cookies. By accessing Rosters.gg, you agreed to use cookies in agreement 
                with the Rosters.gg's Privacy Policy.</p>
            ...
            <p>Unless otherwise stated, Rosters.gg and/or its licensors own the intellectual property rights 
                for all material on Rosters.gg. All intellectual property rights are reserved. You may access 
                this from Rosters.gg for your own personal use subjected to restrictions set in these terms 
                and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Rosters.gg</li>
                <li>Sell, rent or sub-license material from Rosters.gg</li>
                <li>Reproduce, duplicate or copy material from Rosters.gg</li>
                <li>Redistribute content from Rosters.gg</li>
            </ul>

            <p>This Agreement shall begin on the date hereof.</p>

            <p>Parts of this website offer an opportunity for users to post and exchange opinions and 
                information in certain areas of the website. Rosters.gg does not filter, edit, publish 
                or review Comments prior to their presence on the website. Comments do not reflect the 
                views and opinions of Rosters.gg,its agents and/or affiliates. Comments reflect the views 
                and opinions of the person who post their views and opinions. To the extent permitted by 
                applicable laws, Rosters.gg shall not be liable for the Comments or for any liability, 
            ...
            <p>Rosters.gg reserves the right to monitor all Comments and to remove any Comments which can 
            ...
            <p>You hereby grant Rosters.gg a non-exclusive license to use, reproduce, edit and authorize 
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would 
                ...
                hyperlink compensates the absence of Rosters.gg; and (d) the link is in the context of general 
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking 
                to our website, you must inform us by sending an e-mail to Rosters.gg. Please include your 
            ...
            <p>No use of Rosters.gg's logo or other artwork will be allowed for linking absent a trademark 
                license agreement.</p>
