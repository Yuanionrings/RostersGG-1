export default PrivacyPolicy = () => {
    return(
        <div>
            <h1>Privacy Policy for Rosters.gg</h1>
            ...
            <p>At Rosters.gg, accessible from https://www.rosters.gg, one of our main priorities is the privacy 
                ...
                and recorded by Rosters.gg and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our 
                website with regards to the information that they shared and/or collect in Rosters.gg. 
            ...
            <p>Rosters.gg follows a standard procedure of using log files. These files log visitors when they 
            ...
            <p>Like any other website, Rosters.gg uses 'cookies'. These cookies are used to store information 
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web 
                Beacons that are used in their respective advertisements and links that appear on Rosters.gg, 
            ...
            <p>Note that Rosters.gg has no access to or control over these cookies that are used by third-party 
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>Rosters.gg's Privacy Policy does not apply to other advertisers or websites. Thus, we are 
            ...
            <p>Rosters.gg does not knowingly collect any Personal Identifiable Information from children 
